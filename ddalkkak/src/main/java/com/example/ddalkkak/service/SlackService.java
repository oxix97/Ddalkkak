...
public class SlackService {
    ...
    public List<ResponseMessage> getRandomChannelMessages() {
        var response = slackClient.getRandomHistory(1000);
        return responseMapper.getResponseMessages(response);
    }

    public List<ResponseMessage> getLearnChannelMessages() {
        var response = slackClient.getLearnHistory(1000);
        return responseMapper.getResponseMessages(response);
    }

    public ConversationsHistoryResponse getMentoringAll() {
        return slackClient.getSpringMentorHistory(1000);
    }

    public ConversationsHistoryResponse getMentoring(int limit) {
        return slackClient.getSpringMentorHistory(limit);
    }
