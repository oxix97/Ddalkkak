...
public class SlackClient {
    ...
    public String RANDOM_CHANNEL;
    @Value("${slack.channel.learn}")
    public String LEARN_CHANNEL;
    @Value("${slack.team}")
    public String TEAM_ID;

    public ConversationsHistoryResponse getRandomHistory(int limit) {
        return getChannelHistory(RANDOM_CHANNEL, limit);
    }

    public ConversationsHistoryResponse getLearnHistory(int limit) {
        return getChannelHistory(LEARN_CHANNEL, limit);
    }
